...
class LocationService {
    ...
    val aisle1Locations = mapOf(
        ...
        "BULK.A.01" to Location("BULK.A.01", "A", Coordinates(10.0, 290.0), false),
        ...
        "BULK.A.04" to Location("BULK.A.04", "A", Coordinates(60.0, 280.0), false),
        "BULK.A.05" to Location("BULK.A.05", "A", Coordinates(10.0, 270.0), true),
        "BULK.A.06" to Location("BULK.A.06", "A", Coordinates(60.0, 270.0), false),
        "BULK.A.07" to Location("BULK.A.07", "A", Coordinates(10.0, 260.0), true),
        "BULK.A.08" to Location("BULK.A.08", "A", Coordinates(60.0, 260.0), false),
        ...
        "BULK.A.11" to Location("BULK.A.11", "A", Coordinates(10.0, 240.0), false),
        "BULK.A.12" to Location("BULK.A.12", "A", Coordinates(60.0, 240.0), false),
        "BULK.A.13" to Location("BULK.A.13", "A", Coordinates(10.0, 230.0), false),
        "BULK.A.14" to Location("BULK.A.14", "A", Coordinates(60.0, 230.0), true),
        "BULK.A.15" to Location("BULK.A.15", "A", Coordinates(10.0, 220.0), false),
        "BULK.A.16" to Location("BULK.A.16", "A", Coordinates(60.0, 220.0), true),
        "BULK.A.17" to Location("BULK.A.17", "A", Coordinates(10.0, 210.0), false),
        "BULK.A.18" to Location("BULK.A.18", "A", Coordinates(60.0, 210.0), true),
        "BULK.A.19" to Location("BULK.A.19", "A", Coordinates(10.0, 200.0), false),
        ...
        "BULK.A.26" to Location("BULK.A.26", "A", Coordinates(60.0, 170.0), true),
        ...
        "BULK.A.34" to Location("BULK.A.34", "A", Coordinates(60.0, 130.0), true),
        "BULK.A.35" to Location("BULK.A.35", "A", Coordinates(10.0, 120.0), true),
        "BULK.A.36" to Location("BULK.A.36", "A", Coordinates(60.0, 120.0), false),
        "BULK.A.37" to Location("BULK.A.37", "A", Coordinates(10.0, 110.0), false),
        ...
        "BULK.A.43" to Location("BULK.A.43", "A", Coordinates(10.0, 80.0), false),
        "BULK.A.44" to Location("BULK.A.44", "A", Coordinates(60.0, 80.0), false),
        "BULK.A.45" to Location("BULK.A.45", "A", Coordinates(10.0, 70.0), true),
        "BULK.A.46" to Location("BULK.A.46", "A", Coordinates(60.0, 70.0), true),
        "BULK.A.47" to Location("BULK.A.47", "A", Coordinates(10.0, 60.0), false),
        "BULK.A.48" to Location("BULK.A.48", "A", Coordinates(60.0, 60.0), true),
        "BULK.A.49" to Location("BULK.A.49", "A", Coordinates(10.0, 50.0), true),
        "BULK.A.50" to Location("BULK.A.50", "A", Coordinates(60.0, 50.0), false),
        "BULK.A.51" to Location("BULK.A.51", "A", Coordinates(10.0, 40.0), false),
        "BULK.A.52" to Location("BULK.A.52", "A", Coordinates(60.0, 40.0), true),
        "BULK.A.53" to Location("BULK.A.53", "A", Coordinates(10.0, 30.0), false),
    ...
    val aisle2Locations = mapOf(
        ...
        "BULK.B.09" to Location("BULK.B.09", "B", Coordinates(70.0, 250.0), true),
        ...
        "BULK.B.17" to Location("BULK.B.17", "B", Coordinates(70.0, 210.0), true),
        "BULK.B.19" to Location("BULK.B.19", "B", Coordinates(70.0, 200.0), true),
        "BULK.B.21" to Location("BULK.B.21", "B", Coordinates(70.0, 190.0), true),
        ...
        "BULK.B.27" to Location("BULK.B.27", "B", Coordinates(70.0, 160.0), true),
        ...
        "BULK.B.33" to Location("BULK.B.33", "B", Coordinates(70.0, 130.0), true),
        "BULK.B.35" to Location("BULK.B.35", "B", Coordinates(70.0, 120.0), false),
        "BULK.B.37" to Location("BULK.B.37", "B", Coordinates(70.0, 110.0), true),
        "BULK.B.39" to Location("BULK.B.39", "B", Coordinates(70.0, 100.0), false),
        "BULK.B.41" to Location("BULK.B.41", "B", Coordinates(70.0, 90.0), true),
        "BULK.B.43" to Location("BULK.B.43", "B", Coordinates(70.0, 80.0), true),
        "BULK.B.45" to Location("BULK.B.45", "B", Coordinates(70.0, 70.0), true),
        "BULK.B.47" to Location("BULK.B.47", "B", Coordinates(70.0, 60.0), true),
        "BULK.B.49" to Location("BULK.B.49", "B", Coordinates(70.0, 50.0), true),
        "BULK.B.51" to Location("BULK.B.51", "B", Coordinates(70.0, 40.0), true),
        "BULK.B.53" to Location("BULK.B.53", "B", Coordinates(70.0, 30.0), true),
        ...
        "BULK.B.12" to Location("BULK.B.12", "B", Coordinates(120.0, 240.0), true),
        "BULK.B.14" to Location("BULK.B.14", "B", Coordinates(120.0, 230.0), true),
        "BULK.B.16" to Location("BULK.B.16", "B", Coordinates(120.0, 220.0), false),
        "BULK.B.18" to Location("BULK.B.18", "B", Coordinates(120.0, 210.0), true),
        "BULK.B.20" to Location("BULK.B.20", "B", Coordinates(120.0, 200.0), false),
        "BULK.B.22" to Location("BULK.B.22", "B", Coordinates(120.0, 190.0), true),
        "BULK.B.24" to Location("BULK.B.24", "B", Coordinates(120.0, 180.0), true),
        ...
        "BULK.B.32" to Location("BULK.B.32", "B", Coordinates(120.0, 140.0), true),
        "BULK.B.34" to Location("BULK.B.34", "B", Coordinates(120.0, 130.0), true),
        "BULK.B.36" to Location("BULK.B.36", "B", Coordinates(120.0, 120.0), true),
        ...
        "BULK.B.48" to Location("BULK.B.48", "B", Coordinates(120.0, 60.0), true),
        "BULK.B.50" to Location("BULK.B.50", "B", Coordinates(120.0, 50.0), false),
        "BULK.B.52" to Location("BULK.B.52", "B", Coordinates(120.0, 40.0), true),
        ...
        "BULK.B.58" to Location("BULK.B.58", "B", Coordinates(120.0, 10.0), true)
    )
